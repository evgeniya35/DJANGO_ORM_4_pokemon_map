...
class PokemonEntity(models.Model):
    ...
    apperated_at = models.DateTimeField(default=datetime.now, verbose_name='Появляется')
    disapperated_at = models.DateTimeField(default=datetime.now, verbose_name='Исчезает')
    lat = models.FloatField(verbose_name='Широта')
    lon = models.FloatField(verbose_name='Долгота')
    level = models.IntegerField(default=0, blank=True, verbose_name='Уровень', help_text='Поле уровень')
    health = models.IntegerField(default=0, blank=True, verbose_name='Здоровье')
    strength = models.IntegerField(default=0, blank=True, verbose_name='Атака')
